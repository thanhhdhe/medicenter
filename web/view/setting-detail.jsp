        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4 py-4">
                    ...
                    <c:set var="setting" value="${requestScope.settingDeatil}"></c:set>
                    <form action="setting?event=update&settingid=${setting.getSettingID()}" method="POST" class="d-flex flex-column align-items-center justify-content-between">
                        <div class="col-md-9">
                            <div class="d-flex justify-content-center">
                                <img src="${setting.getValue()}" alt="img" class="object-contain" width="200px" height="100px" />
                            </div>
                            <div class="d-flex">
                            ...
                            <div class="col-md-9 px-5">
                                <div class="d-flex">
                                    <div class="form-group pe-4">
                                        ...
                                        <input type="text" class="form-control"  name="type" value="${setting.getType()}" required>
                                        
                                    </div>
                                    <div class="form-group px-4 w-50">
                                        <label  class="detail-info"> Name</label>
                                        <input type="text" class="form-control w-100" name="name" value="${setting.getSettingName()}" required>
                                ...
                                <div class="form-group mt-3 h-50 mb-2">
                                    ...
                                    <input type="text" class="form-control w-75 h-100" id="description" name="description" value="${setting.getDescription()}" required>
