                            ...
                            <div class="col-md-9 px-5">
                                <div class="d-flex">
                                    <div class="form-group pe-4">
                                        ...
                                        <input type="text" class="form-control"  name="type" value="${setting.getType()}">
                                        
                                    </div>
                                    <div class="form-group px-4 w-50">
                                        <label  class="detail-info"> Name</label>
                                        <input type="text" class="form-control w-100" name="name" value="${setting.getSettingName()}">
                                ...
                                <div class="form-group mt-3 h-50 mb-2">
                                    ...
                                    <input type="text" class="form-control w-75 h-100" id="description" name="description" value="${setting.getDescription()}">
