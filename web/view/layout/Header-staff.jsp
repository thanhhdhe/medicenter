            ...
            <div class="dropdown">
                <a href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="appointment-btn scrollto d-flex align-items-center p-1 pe-2">
                        <img class="rounded-circle" style="object-fit: cover;object-position: top;overflow: hidden;width: 40px;height: 40px;" src="<%=curStaff.getProfileImage()%>" alt=""/>
                        <p class="m-0 ms-1">Hi, <%=curStaff.getStaffName()%></p>
