...
public class ReservationContact extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Reservation> listreservation = rd.getReservationByUserID(user.getUserID()+"");
                    
        request.setAttribute("user", user);
        request.setAttribute("Reservation", listreservation);
        request.getRequestDispatcher("/view/reservationcontact.jsp").forward(request, response);
    } 
